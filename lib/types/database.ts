...
export interface User {
  ...
  cedula: string | null  // Opcional después de migración 004
  email: string
  celular: string
...
export interface Team {
  ...
  nombre: string
  codigo: string
  bandera_url: string | null  // Puede ser null en BD
  grupo: string | null
...
export interface Match {
  ...
  fase: MatchPhase
  fecha_hora: string
  estadio: string | null  // Puede ser null en BD
...
export interface SpecialPrediction {
  ...
  creado_en: string
  actualizado_en: string  // Agregado en migración 008
...
// ============================================
// Tipos agregados para tablas faltantes
// ============================================
...
export interface ScoringConfig {
  ...
  puntos_fallido: number
  // Puntos por predicciones especiales
  puntos_campeon: number
  puntos_subcampeon: number
  puntos_goleador: number
  puntos_colombia_grupos: number
  puntos_colombia_octavos: number
  puntos_colombia_cuartos: number
  puntos_colombia_semifinal: number
  puntos_colombia_final: number
  puntos_colombia_campeon: number
  // Configuración del pozo de premios
  inscripcion_valor: number
  premio_primero_porcentaje: number
  premio_exactos_porcentaje: number
  premio_grupos_porcentaje: number
  premio_reserva_porcentaje: number
  // Metadata
